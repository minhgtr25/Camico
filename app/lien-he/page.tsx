    ...
    <main className="min-h-screen bg-[#f5f5dc]">
      ...
      <div className="bg-[#f5f5dc] py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-[#2d5016] mb-4">Liên Hệ Với Chúng Tôi</h1>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Chúng tôi luôn sẵn sàng lắng nghe và hỗ trợ bạn. Hãy liên hệ với CAMICO ngay hôm nay.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-0 md:py-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <p className="text-gray-600 text-sm mb-3">Gọi cho chúng tôi để được tư vấn trực tiếp</p>
              <p className="text-[#2d5016] font-semibold text-lg">(+84) 123 456 789</p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <p className="text-gray-600 text-sm mb-3">Gửi email cho chúng tôi bất kỳ lúc nào</p>
              <p className="text-[#2d5016] font-semibold text-lg">info@camico.com.vn</p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <p className="text-gray-600 text-sm mb-3">Số 123 Đường ABC, Quận 1, TP. Hồ Chí Minh</p>
              <p className="text-[#2d5016] font-semibold text-lg">Việt Nam</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 bg-white rounded-3xl overflow-hidden shadow-lg">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4582.82993520069!2d105.78123107596934!3d21.014323688272853!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abcc1f4d5cef%3A0xd0246a423eb425f3!2zQ1Q1RCBN4buFIFRyw6wgSOG6oQ!5e1!3m2!1svi!2s!4v1764005651967!5m2!1svi!2s"
            width="100%"
            height="450"
            style={{ border: 0 }}
